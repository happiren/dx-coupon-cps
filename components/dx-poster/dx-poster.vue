    ...
    computed: {
      ...
      title() {
        ...
        if (posterTitle) {
          if (this.mainImg) {
              ...
              posterTitle.y = posterTitle.y + data.title.mt * system.scale;
          }
        }
        return posterTitle
      },
      ...
      codeImg() {
        ...
        let posterCode = {
          ...
          y: this.poster.y + data.poster.p * system.scale + data.codeImg.mt * system.scale //y需要加上绘图后文本的y
        }
        console.log(" posterCode",  posterCode)
        return posterCode
      }
    },
    created() {
      ...
      async creatPoster() {
        ...
        if (title) {
          textY = drawTextReturnH(
                  ...
                  title.x,
                  title.y,
                  mainImg ? mainImg.w: this.poster.w,
                  title.fontSize,
                  title.color,
                  title.lineHeight
          )
        ...
        await drawSquarePic(
          ctx,
          codeImg.x,
          textY ? codeImg.y + textY : codeImg.y,
          codeImg.w,
          codeImg.h,
          codeImg.r,
          codeImg.url
        ...
        this.posterData.tips.forEach((element, i) => {
          ...
          y = drawTextReturnH(
            ctx,
            element.text,
            title ? title.x: element.x,
            y,
                  mainImg? mainImg.w : poster.w,
            element.fontSize,
            element.color,
            element.lineHeight,
            element.align

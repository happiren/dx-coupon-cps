		...
		<view class="content">
			...
			<view class="center">
				...
				<view class="center-bottom" :style="theme.topBtnColor" v-for="(item, index) in coupons" :key="index" @click="getCoupon(item)">
					...
					<text v-else="item.title">领红包点外卖{{coupons.length > 1 && index > 0 ? index : ""}}</text>
				</view>
		...
		data() {
			return {
				...
				themes: [{ //
						...
						bgColor: 'background-color:#027ed8',
						topBgImg: '../../static/ele_bg_hb.jpg',
						navigateBgImg: '../../static/ele1_ydl.jpg',
						topBtnColor: 'background-color: #1280d9;color: #fff;',
